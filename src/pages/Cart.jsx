...
const Cart = () => {
    ...
    const {navigate, products, getCartCount, getCartAmount, removeFromCart, updateCartItem, cartItems, currency} = useAppContext();
    const [cartArray, setCartArray] = useState([])
    const [addreses, setAddreses] = useState(dummyAddress)
